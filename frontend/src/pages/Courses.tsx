...
export default function CoursesPage() {
  ...
  // Map rapide pour retrouver le nom du moniteur
  ...
  async function refresh() {
    ...
    // Trie alphabétique pour plus de clarté
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setForm({
                ...form,
                monitor_id: e.target.value ? Number(e.target.value) : undefined,
              })
            }
          >
